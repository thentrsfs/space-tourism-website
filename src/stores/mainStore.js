...
const terminologyInfo = {
    first : {
        ...
        content: "A launch vehicle or carrier rocket is a rocket-propelled vehicle used to carry a payload from Earth's surface to space, usually to Earth orbit or beyond. Our WEB-X carrier rocket is the most powerfull in operation. Standing 150 metres tall, it's quite an awe-inspiring sight on the launch pad!",
        img:'src/assets/technology/image-launch-vehicle-portrait.jpg'
    },
    second : {
        title: 'SPACEPORT',
        content: "A spaceport of cosmodrome is a site for launching(or recieving)spacecraft, by analogy to the seaport for ships or airport for aircraft. Based in the famous Cape Canaveral, our spaceport is ideally situated to take advantage of the Earth's rotation for launch. ",
...
return {bgImgUrl, selectedButton, selectButton, backgroundImages, selectPlanet, selectedPlanet, planetsInfo, selectedCrewMember, selectCrewMember,crewInfo,selectTerminology,selectedTerminology,terminologyInfo}
})